...
if num_cafeterias != 1:
    st.markdown(f"<h2 style='margin-top: 0px; margin-bottom: -100px;'>Tus {num_cafeterias} cafeterías más cercanas</h2>", unsafe_allow_html=True)
else:
    st.markdown(f"<h2 style='margin-top: 0px; margin-bottom: -100px;'>Tu cafetería más cercana</h2>", unsafe_allow_html=True)
